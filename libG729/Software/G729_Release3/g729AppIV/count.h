...
typedef struct
{
    ...
    UWord32 round_fx;           /* Complexity Weight of 1 */
 ...
 * does not use any calls to counter.h or basop32.h. If this is the case
